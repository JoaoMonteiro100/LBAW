            ...
            <div class="well well-sm">
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-8">
                        ...
                        <small>
                        <p>
							<i class="glyphicon glyphicon-user"></i> Cpt_America
                            <br />
							<i class="glyphicon glyphicon-map-marker"></i> USA 
							<br />
                            <i class="glyphicon glyphicon-envelope"></i> cpt_america_askit@fe.up.pt
                            <br />
                            <i class="glyphicon glyphicon-gift"></i> 09/09/1900</p></small>
